const projectsData = [
  ...
  {
    title: "쇼핑몰 웹사이트",
    description: "전자상거래 기능을 포함한 쇼핑몰 웹사이트입니다. 상품 목록, 장바구니, 결제 기능을 구현했습니다.",
    technologies: ["React", "Node.js", "Express"],
    image: "https://via.placeholder.com/400x200/FF6B6B/FFFFFF?text=E-commerce",
    githubUrl: "https://github.com/wjddsmdb/my-shop-app",
